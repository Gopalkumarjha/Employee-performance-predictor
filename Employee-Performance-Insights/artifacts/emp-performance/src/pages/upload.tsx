...
const SAMPLE_CSV = `age,years_at_company,monthly_income,total_working_years,training_times_last_year,distance_from_home,job_satisfaction,percent_salary_hike
28,2,52000,6,3,10,3,15
35,8,78000,10,2,2,4,12
42,15,92000,20,4,15,2,22
26,1,41000,3,1,5,1,11
50,22,115000,25,5,8,4,20
31,4,63000,8,3,12,3,14
38,10,85000,12,2,20,2,25
29,3,58000,5,4,3,4,18`;
      ...
      <Card className="border-primary/20 bg-primary/5">
        ...
        <CardContent>
          <div className="flex flex-wrap gap-2 mb-4">
            {["age", "years_at_company", "monthly_income", "total_working_years", "training_times_last_year", "distance_from_home", "job_satisfaction", "percent_salary_hike"].map((col) => (
